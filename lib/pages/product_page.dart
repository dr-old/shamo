                ...
                children: [
                  ...
                  GestureDetector(
                      ...
                      if (isWishlist) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            ...
                            content: Text(
                              'Has been remove to the Wishlist',
                              style: primaryTextStyle.copyWith(),
                              textAlign: TextAlign.center,
                            ),
                          ),
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        color: !isWishlist ? subtitleTextColor : secondaryColor,
                      ),
                      child: Image.asset(
                        'assets/icons8-favorite-96.png',
                        width: 46,
                        color:
                            !isWishlist ? backgroundColor1 : primaryTextColor,
                      ),
                    ),
                  ),
                ],
              ...
              child: Column(
                ...
                children: [
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: imageFamiliar.map((image) {
                        index++;
                        return Container(
                          margin: EdgeInsets.only(
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Image.asset('assets/icons8-typing-100.png'),
                    ),
                  ),
                  SizedBox(
                    width: 16,
